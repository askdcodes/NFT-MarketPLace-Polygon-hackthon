...
export const NFTProvider = ({ children }) => {
  ...
  return (
    <NFTContext.Provider value={{ nftCurrency, handleGame, handleImage, nftimage, game, buyNft, createSale, fetchNFTs, fetchMyNFTsOrCreatedNFTs, connectWallet, currentAccount, isLoadingNFT }}>
      {children}
    </NFTContext.Provider>
  );
};